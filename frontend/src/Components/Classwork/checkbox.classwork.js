...
const Checkbox = (params) => {
  ...
  useEffect(() => {
    Axios.get(`${URL}/classwork/get/${classworkId}`).then((res) => {
      if (res.data.types === "caixa de selecao") {
  ...
  useEffect(() => {
    Axios.get(`${URL}/classwork/get/resposta/${classworkId}`).then((res) =>
      setAnswers(res.data)
    );
  }, [classworkId]);
    ...
    <div className="container-fluid">
      ...
      <div className="container margin-top-bottom">
        <div className="col-9">
          ...
          {classwork.duedate ? (
            <p>Data de Expiração: {moment(classwork.duedate).fromNow()}</p>
          ) : null}
          <p className="box-text material-description">
            {classwork.description}
          </p>
          <p>
            Postado {moment(classwork.createdAt).fromNow()}
            {classwork.createdAt !== classwork.updatedAt ? (
              <span>(Atualizar {moment(classwork.updatedAt).fromNow()})</span>
            ) : null}{" "}
            : {author}
          </p>
              ...
              <div className="form-group">
                ...
                <div className="box">
                  ...
                  <input
                    ...
                    onKeyPress={(event) =>
                      event.key === "OK" ? addNewChoice(event) : null
                    }
                  />
                </div>
              </div>
      ...
      (classwork.author === userInfo._id ||
        ...
        <div className="classwork-modal" id="answers">
          <div className="classwork-content container">
            ...
            <h1 className="box-title">Respostas dos alunos:</h1>
            {answers.map((answer) => {
              return (
                <p key={answer._id}>
                  {answer.student.username} Respondidos{" "}
