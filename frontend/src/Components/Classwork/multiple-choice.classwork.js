...
const MultipleChoice = (params) => {
    ...
    useEffect(() => {
        ...
        .then(res => {
            if(res.data.types === "multipla escolha"){
        ...
        <div className = "container-fluid">
            ...
            <div className="container margin-top-bottom">
                <div className="col-9">
                    ...
                    {classwork.createdAt !== classwork.updatedAt? <span>(atualizado {moment(classwork.updatedAt).fromNow()})</span>: null} por {author}</p>
                    {classwork.author === userInfo._id? <div><h3><span className="link" onClick = {openClasswork}>Editar</span></h3>
                    <h3><span className="link text-danger" onClick = {deleteClasswork}>Deletar</span></h3></div>:null}
                </div>
                ...
                <div className="col-3">
                    ...
                    <form className="box box-shadow" onSubmit = {Answer}>
                        <h1 className="box-title">Responder:</h1>
                ...
                <div className="col-3">
                    <div className="box box-shadow">
                        ...
                        <p className="box-text">{classwork.answer?classwork.answer.length:null} respondidos</p>
