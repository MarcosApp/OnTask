...
const ClassSetting = (params) => {
    ...
    const updateClassInfo = e => {
        ...
        .then(() => setUpdateInfo("Informações da aula atualizadas."))
    }
        ...
        <div className="container-fluid">
            ...
            <div className="container form-login">
                <form className="margin-top-bottom box box-shadow" onSubmit = {updateClassInfo}>
                    <h1 className="box-title">Atualizar informações da aula:</h1>
                ...
                <div className="margin-top-bottom box box-shadow">
                    ...
                    <ul>
                        ...
                        :<h3>Ainda não há alunos. Enviar código de aula({classInfo.code}) para o seu aluno.</h3>}
                    </ul>
                </div>
