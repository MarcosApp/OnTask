        ...
        <nav>
            <nav className='bg-white text-dark topnav'>
                <div id = "sidenav" className="sidenav">
                    ...
                    <NavLink to="/" className="sidenav-title">Turma</NavLink>
                    {classes.map(_class => {
                    ...
                    <NavLink to = "/archived" className="sidenav-title">Aula Arquivada</NavLink>
                </div>
                <span className="nav-logo  nav-ham hamburger" onClick = {openNav}>☰</span>
            ...
            {Object.keys(classInfo).length > 0 && classInfo.owner === userInfo._id?
                <nav className="center bg-white text-dark topnav">
                    <p className="col-3 option nav-ham"><NavLink to = {`/class/${classInfo._id}`} className=" link">Visão Geral</NavLink></p>
                    <p className="col-3 option nav-ham"><NavLink to = {`/class/${classInfo._id}/classwork`} className="link">Trabalho de classe</NavLink></p>
                    <p className="col-3 option nav-ham"><NavLink to = {`/class/${classInfo._id}/people`} className="link">Pessoas</NavLink></p>
                    <p className="col-3 option nav-ham"><NavLink to = {`/class/${classInfo._id}/setting`} className ="link">Configurações</NavLink></p>
                </nav>
            : <nav className="center bg-white text-dark topnav">
                <p className="col-4 nav-ham optc"><NavLink to = {`/class/${classInfo._id}`} className=" link">Visão Geral</NavLink></p>
                <p className="col-4 nav-ham optc"><NavLink to = {`/class/${classInfo._id}/classwork`} className="link">Trabalho de classe</NavLink></p>
                <p className="col-4 nav-ham optc"><NavLink to = {`/class/${classInfo._id}/people`} className="link">Pessoas</NavLink></p>
            </nav>}
        </nav>
    )
}
